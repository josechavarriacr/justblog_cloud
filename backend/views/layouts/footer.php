			...
			<div class="row">
				<div class="col-md-6 col-md-push-0 item text">
					<div class="bs-docs-footer-links">
						...
						<a href="<?=Yii::$app->urlManagerFrontend->createUrl('feedback')?>">Feedback</a>
					</div>
					<p>Developed with passion and gallo pinto for a better web, <a href="https://github.com/josechavarriacr/justblog" target="_blank">¡Fork It!</a></p>
